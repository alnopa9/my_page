...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <link rel="stylesheet" href="argento_11-09_XSLT-07.css" />
            ...
            <body>
                <div class="body-container">
                    <div class="position-bar">
                        <p>
                            <a href="#1forwards">Forwards</a> | <a href="#1defense">Defense</a> | <a href="#1goalies">Goalies</a>
                        </p>
                    </div>
                    <div class="team-name">
